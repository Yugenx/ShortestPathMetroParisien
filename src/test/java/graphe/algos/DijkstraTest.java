...
class DijkstraTest   {
    ...
    void testerTousLesGraphes() {
        ...
        //GraphDirectoryImporter importer = new GraphDirectoryImporter(Main.GRAPHES_REP, Main.REPONSES_REP, true, new GrapheLAdj());
        //GraphDirectoryImporter importer = new GraphDirectoryImporter(Main.GRAPHES_REP, Main.REPONSES_REP, true, new GrapheMAdj());
        //GraphDirectoryImporter importer = new GraphDirectoryImporter(Main.GRAPHES_REP, Main.REPONSES_REP, true, new GrapheHHAdj());
